        ...
        static void Main()
        {
            ...
            */
            ...
            var WebServiceEndpoints = new List<BWebPrefixStructure>()
            {
                ...
                new BWebPrefixStructure(new string[] { "/3d/ping" }, () => new HandleRequest(CadFileServiceBaseUrl)/*Ping-pong; for avoiding scale-down-to-zero*/),
                new BWebPrefixStructure(new string[] { "/3d/internal/*" }, () => new HandleRequest(CadFileServiceBaseUrl)/*Internal services have secret based auth check, different than login mechanism*/),
                new BWebPrefixStructure(new string[] { "/3d/*" }, () => new HandleRequest(CadFileServiceBaseUrl).WithLoginRequirement(AuthServiceBaseUrl)),
